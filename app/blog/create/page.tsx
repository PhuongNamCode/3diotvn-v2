  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/blog', {
        ...
        body: JSON.stringify({
          ...formData,
          published: false // Mặc định chưa publish, cần admin duyệt
        }),
      });
      ...
      if (result.success) {
        setSuccess('Bài viết đã được tạo thành công! Đang chờ admin duyệt.');
        setTimeout(() => {
          router.push('/blog');
        }, 2000);
      } else {
  ...
  return (
    <div className="container">
      <div className="blog-create-header">
        ...
        <p>Chia sẻ kiến thức và kinh nghiệm của bạn với cộng đồng 3DIoT</p>
      </div>
